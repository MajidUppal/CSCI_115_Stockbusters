        ...
        for symbol in stock_symbols:
            ...
            if len(stock_data) > 0:
                ...
                if short_term:
                    ...
                    ai_score = float(stock_info.get('Fundamental_Score', 0)) if pd.notna(stock_info.get('Fundamental_Score')) else 0.0
                else:
                ...
                recommendations.append({
                    ...
                    "sharpe": float(stock_info.get('sharpe_1m_annual', stock_info.get('sharpe_1m_annual', 0))) if pd.notna(stock_info.get('sharpe_1m_annual', stock_info.get('sharpe_1m_annual', 0))) else 0.0,
                    "cagr": float(stock_info.get('cagr', stock_info.get('CAGR', 0))) if pd.notna(stock_info.get('cagr', stock_info.get('CAGR', 0))) else 0.0,
                    "max_drawdown": float(stock_info.get('max_drawdown', stock_info.get('Max_Drawdown', 0))) if pd.notna(stock_info.get('max_drawdown', stock_info.get('Max_Drawdown', 0))) else 0.0
                })
