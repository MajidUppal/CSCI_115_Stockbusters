...
class TestIntegration:
    ...
    def test_full_pipeline(self, sample_data):
        ...
        expected_cols = [
            'Hybrid_Score', 'Technical_Score', 'Fundamental_Score',
            'Hybrid_CS_Pct', 'Hybrid_Rank', 'H_Score Recommendation',
            'n_periods', 'sharpe_1m_annual', 'cagr', 'max_drawdown'
        ]
