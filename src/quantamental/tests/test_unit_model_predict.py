...
class TestLoadModelFromWandb:
    ...
    def test_load_model_from_wandb_success(self, mock_wandb, sample_config, mock_model, mock_scaler):
...
class TestPreparePredictionData:
    ...
    @pytest.mark.unit
    def test_prepare_prediction_data_creates_lags(self, sample_config, sample_prediction_data):
...
class TestPredict:
    ...
    @pytest.mark.unit
    def test_predict_adds_probabilities(self, sample_config, sample_prediction_data, mock_model, mock_scaler):
...
class TestGetTopStocks:
    ...
    @pytest.mark.unit
    def test_get_top_stocks_returns_top_n(self, sample_config, sample_prediction_data, mock_model, mock_scaler):
...
class TestPredictNextMonth:
    ...
    def test_predict_next_month_with_wandb(self, mock_load, sample_config, sample_prediction_data, mock_model, mock_scaler):
        ...
        df_predict, top_stocks = predictor.predict_next_month(sample_prediction_data, top_n=5, use_wandb=True)
...
class TestSavePredictions:
    ...
    @pytest.mark.unit
    def test_save_predictions_creates_file(self, sample_config, sample_prediction_data, mock_model, mock_scaler, tmp_path):
